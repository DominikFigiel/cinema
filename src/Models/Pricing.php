...
class Pricing extends Model {
    ...
    public function getAllForWeekendsByType($type = "2D"){
        if($this->pdo === null){
            $data['error'] = \Config\Database\DBErrorName::$connection;
            return $data;
        }
        ...
        try{
            $query = "
                    ...
                    = `".\Config\Database\DBConfig::$tableType."`.`".\Config\Database\DBConfig\Type::$IdType."`
                    WHERE `".\Config\Database\DBConfig::$tableType."`.`".\Config\Database\DBConfig\Type::$Type."` like '%".$type."%' 
                    AND `".\Config\Database\DBConfig::$tablePricing."`.`".\Config\Database\DBConfig\Pricing::$WorkingDay."` = 0  
                    ORDER BY `".\Config\Database\DBConfig::$tablePricingCategory.'`.`'.\Config\Database\DBConfig\PricingCategory::$PricingCategoryName."`
            ";
            $stmt = $this->pdo->query($query);
            $pricings = $stmt->fetchAll();
    ...
    public function getAllForWorkingDaysByType($type = "2D"){
        if($this->pdo === null){
            $data['error'] = \Config\Database\DBErrorName::$connection;
            return $data;
        }
        ...
        try{
            $query = "
                    ...
                    = `".\Config\Database\DBConfig::$tableType."`.`".\Config\Database\DBConfig\Type::$IdType."`
                    WHERE `".\Config\Database\DBConfig::$tableType."`.`".\Config\Database\DBConfig\Type::$Type."` like '%".$type."%' 
                    AND `".\Config\Database\DBConfig::$tablePricing."`.`".\Config\Database\DBConfig\Pricing::$WorkingDay."` = 1  
                    ORDER BY `".\Config\Database\DBConfig::$tablePricingCategory.'`.`'.\Config\Database\DBConfig\PricingCategory::$PricingCategoryName."`
            ";
            $stmt = $this->pdo->query($query);
            $pricings = $stmt->fetchAll();
